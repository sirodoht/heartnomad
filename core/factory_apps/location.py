...
class LocationFactory(DjangoModelFactory):
    ...
    def add_stuff(self, create, extracted, **kwargs):
        ...
        events.EventFactory(location=self, admin=event_admin, series=event_series)
...
class LocationFeeFactory(DjangoModelFactory):
    class Meta:
        model = LocationFee
...
class LocationMenuFactory(DjangoModelFactory):
    class Meta:
        model = LocationMenu
...
class LocationFlatPageFactory(DjangoModelFactory):
    class Meta:
...
class LocationEmailTemplateFactory(DjangoModelFactory):
    class Meta:
...
class CapacityChangeFactory(DjangoModelFactory):
    class Meta:
...
class BackingFactory(DjangoModelFactory):
    class Meta:
        model = Backing
