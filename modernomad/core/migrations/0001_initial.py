    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.CharField(max_length=100, verbose_name="Fee Name"),
                ),
                (
                    "percentage",
                    models.FloatField(default=0, help_text="For example 5.2% = 0.052"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subject",
                    models.CharField(
                        max_length=200, verbose_name="Default Subject Line"
                    ),
                ),
                (
                    "name",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.CharField(
                        help_text="Try to make this short and sweet. It will also be used to form several location-specific email addresses in the form of xxx@<your_slug>.mail.embassynetwork.com",
                        max_length=60,
                        unique=True,
                    ),
                ),
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        upload_to=modernomad.core.models.location_img_upload_to,
                    ),
                ),
                (
                    "profile_image",
                ...
                (
                    "stay_page",
                    models.TextField(
                        default="This is the page which has some descriptive text at the top (this text), and then lists the available rooms. HTML is supported."
                    ),
                ),
                (
                    "front_page_stay",
                    models.TextField(
                        default="This is the middle of three sections underneath the main landing page text to entice people to stay with you, and then links to the stay page (above). HTML is supported."
                    ),
                ),
                (
                    "front_page_participate",
                    models.TextField(
                        default="This is far right of three sections underneath the main landing page text to tell people how to get involved with your community. There is a link to the Events page underneath. HTML is supported. "
                    ),
                ),
                (
                    "announcement",
                ...
                (
                    "timezone",
                    models.CharField(
                        help_text='Must be an accurate timezone name, eg. "America/Los_Angeles". Check here for your time zone: http://en.wikipedia.org/wiki/List_of_tz_database_time_zones',
                        max_length=200,
                    ),
                ),
                (
                ...
                (
                    "check_out",
                    models.CharField(
                        help_text="When your guests should be out of their bed/room.",
                        max_length=20,
                    ),
                ),
                (
                    "check_in",
                    models.CharField(
                        help_text="When your guests can expect their bed to be ready.",
                        max_length=200,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="house_admin", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "readonly_admins",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text_body",
                    models.TextField(verbose_name="The text body of the email"),
                ),
                (
                    "html_body",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fee",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="core.fee"
                    ),
                ),
                (
                    "location",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="A short title for your menu. Note: If there is only one page in the menu, it will be used as a top level nav item, and the menu name will not be used.",
                        max_length=15,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Displayed on room detail page only",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "users",
                    models.ManyToManyField(
                        related_name="backings", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "resource",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "arrive_deprecated",
                    models.DateField(null=True, verbose_name="Arrival Date"),
                ),
                (
                    "depart_deprecated",
                    models.DateField(null=True, verbose_name="Departure Date"),
                ),
                (
                    "arrival_time_deprecated",
                    models.CharField(
                        blank=True,
                        help_text="Optional, if known",
                        max_length=200,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        null=True,
                        verbose_name="Any additional comments. (Optional)",
                    ),
                ),
                (
                    "rate",
                ...
                ("suppressed_fees", models.ManyToManyField(blank=True, to="core.fee")),
                (
                    "location_deprecated",
                    models.ForeignKey(
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    imagekit.models.fields.ProcessedImageField(
                        upload_to=modernomad.core.models.profile_img_upload_to
                    ),
                ),
                (
                    "bio",
                ...
                (
                    "links",
                    models.TextField(
                        blank=True, help_text="Comma-separated", null=True
                    ),
                ),
                (
                    "phone",
                    models.CharField(
                        blank=True,
                        help_text="Optional. Most locations operate primarily by email, but a phone number can be helpful for last minute coordination and the unexpected.",
                        max_length=20,
                        null=True,
                ...
                (
                    "discussion",
                    models.TextField(
                        help_text="We like discussing thorny issues with each other. What's a question that's been on your mind lately that you don't know the answer to?"
                    ),
                ),
                (
                    "referral",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "use",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="core.use"
                    ),
                ),
            ],
        ),
