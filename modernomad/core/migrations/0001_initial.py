    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bill', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='line_items', to='core.bill')),
                ('fee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.fee')),
            ],
        ),
        migrations.CreateModel(
            name='Location',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.ForeignKey(help_text='Note: If there is only one page in the menu, it will be used as a top level nav item, and the menu name will not be used.', on_delete=django.db.models.deletion.CASCADE, related_name='pages', to='core.locationmenu')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('bill', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='payments', to='core.bill')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resources', to='core.location')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='uses', to='core.location')),
                ('resource', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.resource')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_deprecated', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bookings', to=settings.AUTH_USER_MODEL)),
                ('suppressed_fees', models.ManyToManyField(blank=True, to='core.fee')),
                ('location_deprecated', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bookings', to='core.location')),
                ('resource_deprecated', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.resource')),
                ('use', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='booking', to='core.use')),
                ('bill', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='booking', to='core.bookingbill')),
            ],
        ),
        migrations.CreateModel(
            name='UseNote',
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('note', models.TextField(blank=True, null=True)),
                ('booking_deprecated', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='booking_notes', to='core.booking')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='bills', to='core.subscription')),
            ],
            options={
