...
class UserProfileFormTest(TestCase):
    def test_create_username(self):
        ...
        self.assertEqual(
            create_username(
                "Joe", "Blooooooooooooooooooooooooooooooooooooooooooooooooggs"
            ),
            "joe-blooooooooooooooooooo",
        )
        self.assertEqual(
            create_username(
                "Joe",
                "Blooooooooooooooooooooooooooooooooooooooooooooooooggs",
                suffix="2",
            ),
            "joe-blooooooooooooooooooo-2",
        )
    ...
    def test_users_are_given_unique_usernames(self):
        ...
        user = User(username="joe-bloggs", first_name="Joe", last_name="Bloggs")
