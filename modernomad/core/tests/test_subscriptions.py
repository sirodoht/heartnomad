...
class SubscriptionTestCase(TestCase):
    def setUp(self):
        self.location = Location.objects.create(
            latitude="0", longitude="0", name="Test Location", slug="test"
        )
        self.user1 = User.objects.create(
            username="member_one", first_name="Member", last_name="One"
        )
        self.admin = User.objects.create_superuser(
            username="admin", email="blah@blah.com", password="secret"
        )
